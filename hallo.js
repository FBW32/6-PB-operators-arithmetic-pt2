...
let oneNight = 6450;
let ticket = 15;
console.log(oneNight / ticket); //430
/* Q2. Sylvia's income is 500 dollars per week. How much does Sylvia makes every year? */
let weekIncome = 500;
let weeksInYear = 52;
console.log(weekIncome * weeksInYear); //26000
/* Q3. Calculate the percentage of 17/30. Expected output: number% */
let number = 17;
let percentage = 30;
console.log(percentage / 100); // 0,3
let percentAsDecimal = 0.3;
console.log(percentAsDecimal * number); // 5.1
...
let sideTwo = 6;
let sideTree = 7;
console.log(sideOne + sideTwo + sideTree); // 18
